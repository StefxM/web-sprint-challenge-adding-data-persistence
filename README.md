...
1.Explain the difference between Relational Databases and SQL. Relational databases are table that hold our data and SQL is what we use to run querys to retrieve the data

2.Why do tables need a primary key? a Unique column in our table that lets us access the rows

3.What is the name given to a table column that references the primary key on another table. Foreign key

4.What do we need in order to have a many to many relationship between two tables.
A intermediary table that holds our foreign keys
_______
